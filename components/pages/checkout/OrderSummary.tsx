...
const OrderSummary = ({ checkout, checkoutState }: Props) => {
    const allowOrderToBePlaced =
        checkoutState.shippingAddressCompleted &&
        checkoutState.shippingMethodCompleted &&
    ...
    return (
        <div className="col-span-2 border border-slate-100 rounded-lg p-4 flex-row space-y-3 h-min mb-6 md:mb-0 bg-white shadow-sm">
            ...
            <p className="text-xs text-slate-500">
                By placing your order, you agree to our <span className="underline">Terms of Use</span> and{" "}
