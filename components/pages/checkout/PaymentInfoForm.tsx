		...
		<div className="flex flex-col border-b border-b-slate-200 pb-6">
			<div className="flex justify-between">
				<h1 className="text-lg font-semibold flex items-center">
					Payment Information
					{checkoutState.paymentInfoCompleted && <GoCheck className="ml-2 text-emerald-500" size={24}/>}
				</h1>
			</div>
				...
				<form>
					<div className="grid grid-cols-6 gap-4">
						<div className="col-span-6">
							<PaymentElement onChange={e => checkoutState.setPaymentInfoCompleted(e.complete)}/>
						</div>
					</div>
				</form>
			</div>
