...
const ItemsList = () => {
	...
	return (
		<div
			className="py-4 px-4 sm:px-0 flex flex-col space-y-4 min-w-full border-b border-slate-200 max-h-[21.5rem] scrollbar-thin scrollbar-thumb-gray-300 scrollbar-thumb-rounded-full">
			{cartItems.map(cartItem =>
				<div className="flex space-x-3 px-3" key={cartItem.id}>
					<div className="relative">
						...
						<span
							className="absolute -top-2 -right-2 block h-5 w-5 rounded-full ring-1 ring-white bg-sky-400 text-white text-xs flex justify-center items-center">
							1
						</span>
					</div>
