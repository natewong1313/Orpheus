 ...
 */
const getCountry = function getCountry(countryCode) {
	const required = require("./".concat(countryCode.toUpperCase(), ".json"))
...
const getCountries = function getCountries(filter) {
	const list = filter || require("./countries.json").map(function (item) {
		return item.code
